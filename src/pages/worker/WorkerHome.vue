      ...
      <div class="workerHomeTab h-full">
        ...
        <div class="flex">
          <h2
            ...
            :class="activeTab === 'home' ? ' bg-[#FF6F00] text-[#fff]' : 'bg-[#fff] text-[#767676]'"
          >
            홈
          </h2>
          <h2
            ...
            class="flex-1 text-center cursor-pointer py-[19px] mx-auto font-bold text-2xl"
            :class="activeTab === 'todayWork' ? ' bg-[#FF6F00] text-[#fff]' : 'bg-[#fff] text-[#767676]'"
          >
            오늘 할 일
          </h2>
        </div>
        ...
        <section v-if="activeTab === 'home'" class="home-wrap mx-auto">
          ...
          <div class="w-full max-w-[700px] mt-[35px] pb-[140px] mx-auto">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
              ...
              >
                <img
                  class="w-[210px] h-40 rounded-[10px] object-cover"
        ...
        <section v-if="activeTab === 'todayWork'" class="todayWork-wrap h-full">
          <div class="todayWorkMapWrap w-full h-full min-h-screen" id="map">
            ...
            <div class="flex justify-between w-full">
              ...
              <div class="flex items-start gap-2">
                <div
                  ...
                  class="w-16 h-16 border border-dashed border-gray-400 rounded-[10px] flex items-center justify-center text-gray-400 text-xl cursor-pointer"
                >
                  +
                </div>
              ...
              <!-- 오른쪽: 픽업완료 버튼만 하단 정렬 -->
              <div class="self-end">
                <button class="bg-[#FF6F00] text-white px-6 py-2 rounded-[10px] font-bold text-sm whitespace-nowrap">
                  픽업완료
                </button>
              </div>
            </div>
