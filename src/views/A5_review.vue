...
const visibleReviews = computed(() => (showAllReviews.value ? allReviews.value : allReviews.value.slice(0, defaultVisible)));
// 리뷰 더보기
const toggleReviews = () => {
    ...
    <div class="A5-inner">
      ...
      <div class="review-box" v-for="(review, index) in visibleReviews" :key="index">
        ...
        <div class="review-images">
          <img v-for="(img, imgIndex) in getThreeImages(review.images)" :key="imgIndex" :src="img" alt="리뷰 이미지" class="user-image" />
        </div>
      </div>
